...
import logo from '../assets/logo.png'
    function Footer() {
        return (
        <section className="relative overflow-hidden bg-white" style={{ color: '#fff', textAlign: 'center', marginTop: 'auto', padding: '20px' }}>
          ...
          <div className="w-auto p-8">
            <ul className="-m-5 flex wrap items-center" style={{fontSize:"small"}}>
              <li className="p-5">
